...
No build/lint/test tooling is wired up yet. Once the monorepo is scaffolded, this section should be updated with the concrete pnpm/Turborepo commands (`pnpm install`, `pnpm turbo run build|lint|test`, CDK deploy, and how to run a single test).